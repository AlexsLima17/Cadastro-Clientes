...
async function adicionarCliente() {
    ...
    try {
        ...
        alert(data.success ? 'Cliente adicionado com sucesso!' : 'Erro ao adicionar cliente.');
    } catch (error) {
...
async function excluirCliente() {
    ...
    try {
        ...
        const data = await response.json();
        alert(data.success ? 'Cliente excluído com sucesso!' : 'Erro ao excluir cliente.');
    } catch (error) {
...
async function editarCliente() {
    ...
    try {
        ...
        const data = await response.json();
        alert(data.success ? 'Cliente editado com sucesso!' : 'Erro ao editar cliente.');
    } catch (error) {
...
function obterDadosFormulario() {
    ...
    return { nome, cpf, telefone, cep, complemento, numero, estado, cidade };
}
